...
jQuery.fn.dataTable.Api.register('MakeCellsEditable()', function (settings) {
    ...
    if (table != null) {
        ...
        $(table.body()).on('dblclick', 'td', function () {
            ...
            // Determina si la columna tiene la la propiedad no editable
            if (((settings.columns && settings.columns.indexOf(currentColumnIndex) > -1) || (!settings.columns)) && $(this).data('noedit').toUpperCase() != "TRUE") {
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        ...
        case "textarea-confirm":
            ...
            break;
        default: // text input
            input.html = "<input name='cellEdit' onfocus='selectCell(this)'  id='ejbeatycelledit' class='" + inputCss + "' onfocusout='$(this).updateEditableCell(this)' value='" + oldValue + "'></input>";
            break;
    }
    return input;
}
